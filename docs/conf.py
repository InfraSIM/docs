# -*- coding: utf-8 -*-
#
# InfraSIM documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'InfraSIM.tex', u'InfraSIM Documentation',
   u'EMC', 'manual'),
]
...
man_pages = [
    (master_doc, 'InfraSIM', u'InfraSIM Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'InfraSIM', u'InfraSIM Documentation',
   author, 'InfraSIM', 'One line description of project.',
   'Miscellaneous'),
]
